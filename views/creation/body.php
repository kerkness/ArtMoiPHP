<? if(($collections) && ($collections->items)) : ?>
            <div id="content">
                <div id="piece">
<!--                    <div class="image">-->
<!--                        <img src="--><?//=$collections->items[0]->images[0]->imageFileSized?><!--" />-->
<!--                    </div>-->
...
<!--                    <div id="image" style="background: url('--><?//=$collections->items[0]->images[0]->imageFileSized?><!--') no-repeat center top; height: 580px; background-size:auto 100%; "></div> -->
                    <div id="image" style="background: url('<?=$collections->items[0]->images[0]->imageFileSized?>') no-repeat center top; height: 580px; background-size:auto 100%; "></div>
                    <div id="details">
                            <?if($collections->items[0]->title) : ?><span class="title"><?=$collections->items[0]->title?></span><?endif?>
                            ...
                            <?if($collections->items[0]->price || $collections->items[0]->status) : ?>
                                <span class="price"><?if($collections->items[0]->price) : ?> <?=$collections->items[0]->price?>
                                <?else:?>
